 ...
 * @params {Object} - adapter - a NodeJS module which exports View and Controller constructors.
...
.add('adapter', function (adapter) {
  ...
  Sara.adapters.push(adapter.lib)
  return this
})
...
.add('Model', Model)
.add('Utils', _)
.add('adapters', []) // FIXME: Wat is this?
 ...
 */
.method('asset', function (route, data) {
