...
// Retreive the controller action by a route
...
// Methods for making requests with Sara
Sara.method('request', function (method, route) {
  this.routes[method.toUpperCase()][route].call()
}).method('visit', function (route) {
