...
var Data        = Sara.Data        = require('./sara/data')
var Binding     = Sara.Binding     = Data.Binding
var BindingList = Sara.BindingList = Data.BindingList
var Server      = Sara.Server      = require('./sara/server')
var Model       = Sara.Model       = require('./sara/model')
var DOM         = Sara.DOM         = require('./sara/dom')
var Node        = Sara.Node        = DOM.Node
var NodeList    = Sara.NodeList    = DOM.Node
...
Sara.add('bind', function (name, array) {
  if (array) return new BindingList(name, array)
