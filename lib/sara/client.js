...
module.exports = function Client(app) {
  ...
  socket.onmessage = function (json) {
    // FIXME: Implement #50 here, dirty diffs
  }

  this.tryInitRouter = function () {
    if (_.every(app.dbstatus)) app.paths[window.location.pathname]()
  }
  ...
  // Event forwarding
  forwardEvents(['click', 'CheckboxStateChange', 'RadioStateChange', 'close', 'command', 'input', 'beforeInput', 'change', 'submit', 'keypress', 'keyup', 'keydown', 'focusin', 'focusout', 'contextmenu'])
