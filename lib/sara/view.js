  ...
  if (options.render) this.render = function (context, callback) {
    ...
    if (IS_SERVER) {
      ...
      if (options.prerender instanceof Function || options.prerender === false) {
        ...
        readable.push('<meta name="saraClientId" content="'+ id + '">' + '<script async src="/index.js" type="text/javascript"></script>')
        readable.push(Sara.layout.toString())
        readable.push(null)

        // Stream the prerender function
        if (options.prerender instanceof Function) readable.push(options.prerender(context))
